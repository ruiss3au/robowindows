...
- Internal worker timing and translation/interpreter-fallback counters are
  ...
  interval per core. Bounded terminal reporting is now installed and device
  validated: legacy emits none, all 18 x86 stages pass, and all ten unchanged
  Normal-first cache cases have valid tails and zero recorded audio/scheduling/
  graphics errors. Both real profiles remain clean and unchanged. DynRec
  translation counts distinguish warm (52), cold (12,334), two-sweep reuse
